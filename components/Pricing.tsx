          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                Nossa remuneração é justa e focada em resultados. O valor de agência cobre a gestão de mídia paga para investimentos de até R$ 5.000,00 mensais nas plataformas.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 bg-slate-800/50 p-6 rounded-3xl border border-slate-700">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Contrato inicial de 6 meses para maturação das estratégias.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white text-slate-900 rounded-3xl p-8 lg:p-12 shadow-2xl relative">
              ...
              <div className="mb-8">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-black font-montserrat">R$ 2.500<span className="text-lg font-medium">,00</span></span>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-slate-50 rounded-2xl flex justify-between items-center">
                  ...
                  <span className="font-bold text-brand-coral">R$ 700,00</span>
                </div>
