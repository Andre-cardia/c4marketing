-- ============================================================
-- Adiciona acceptance_id ao retorno de query_all_projects
--
-- Necessário para o frontend correlacionar o responsável
-- interno com a linha de projeto (agrupada por acceptance).
-- ============================================================
