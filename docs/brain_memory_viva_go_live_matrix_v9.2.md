...
| 9 | Memória de longo prazo (dias/semanas) | Testes automatizados para continuidade entre sessões longas | Em risco | Suíte T+1/T+7/T+30 criada + CI diária; baseline ainda em `PENDING` por janela temporal | Médio | Acumular janela real e fechar 14 dias estáveis |
